 						...
 						for (var i = 0; i < data.length; i++) {
 							if (data[i].sfztcode == "3") {
 								$(".costing-list").append("<li class=\"mui-table-view-cell\" caobiaoid=\"" + data[i].caobiaoid +
 									...
 									data[i].kjyear + "-" + data[i].period + "</span><span class=\"cost-record-left\">\u8D77\u6570:" + data[
 										i]
 									.Qids +
 			...
 			$.ajax({
 				...
 				success: function success(data) {
 					...
 					$(content).append("<ul class='mui-table-view user-info'>" +
 						...
 						"<li class='mui-table-view-cell'>" + "<span>" + "一阶气费：" + ((Number(data.yonghuChaobiao.bcql1) * Number(
 							data
 							.yonghuChaobiao
 						...
 						"<li class='mui-table-view-cell'>" + "<span>" + "二阶气费：" + ((Number(data.yonghuChaobiao.bcql2) * Number(
 							data
 							.yonghuChaobiao
 						...
 						"<li class='mui-table-view-cell'>" + "<span>" + "三阶气费：" + ((Number(data.yonghuChaobiao.bcql3) * Number(
 							data
 							.yonghuChaobiao
 						...
 						"<li class='mui-table-view-cell'>" + "<span>" + "四阶气费：" + ((Number(data.yonghuChaobiao.bcql4) * Number(
 							data
 							.yonghuChaobiao
